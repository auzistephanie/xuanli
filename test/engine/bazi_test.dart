...
void main() {
  ...
  group('農曆輸入', () {
    test('農曆轉公曆：1999 年農曆八月十一 → 公曆 1999-09-20', () {
      final solarDate = lunarToSolarDate(
        year: 1999,
        month: 8,
        day: 11,
        isLeapMonth: false,
    ...
    test('閏月轉公曆：2023 年閏二月初一 → 公曆 2023-03-22', () {
      final solarDate = lunarToSolarDate(
        year: 2023,
        month: 2,
        day: 1,
      ...
      expect(solarDate, DateTime(2023, 3, 22));
    });

    test('不存在嘅閏月會被拒絕', () {
      expect(
        () =>
            lunarToSolarDate(year: 1999, month: 8, day: 11, isLeapMonth: true),
        throwsArgumentError,
      );
    });
  });
