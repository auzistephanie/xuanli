...
/// Builds the app [ThemeData] from [XuanLiColors].
///
/// [ColorScheme] roles pinned to brand colors here: `primary`, `secondary`,
/// `error`, `surface`, `tertiary`, `outline`, `outlineVariant`, `onSurface`,
/// `surfaceContainerHigh`, `surfaceContainerHighest`. Every other role
/// (e.g. `primaryContainer`, `onSecondary`, `inverseSurface`, `shadow`) is
/// still seed-generated by [ColorScheme.fromSeed] and may not match a brand
/// color — prefer `Theme.of(context).extension<XuanLiColors>()!` (or the
/// `context.xuanliColors` shortcut below) over bare
/// `Theme.of(context).colorScheme.X` for anything not in the pinned list
/// above.
class XuanLiTheme {
  ...
  static ThemeData _build(XuanLiColors colors, Brightness brightness) {
    final colorScheme = ColorScheme.fromSeed(
      ...
      outline: colors.ink30,
      outlineVariant: colors.ink12,
...
/// Ergonomic shortcut for `Theme.of(context).extension<XuanLiColors>()!`.
extension XuanLiThemeContext on BuildContext {
  XuanLiColors get xuanliColors => Theme.of(this).extension<XuanLiColors>()!;
}
